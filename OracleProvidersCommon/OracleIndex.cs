...
namespace ScrewTurn.Wiki.Plugins.OracleCommon {
	...
	/// <summary>
	/// Implements a Oracle-based search engine index.
	/// </summary>
	public class OracleIndex : IIndex {
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:OracleIndex" /> class.
		/// </summary>
		/// <param name="connector">The connection object.</param>
		public OracleIndex(IIndexConnector connector) {
	...
	/// <summary>
	/// Implements a word fetcher for a Oracle-based index.
	/// </summary>
