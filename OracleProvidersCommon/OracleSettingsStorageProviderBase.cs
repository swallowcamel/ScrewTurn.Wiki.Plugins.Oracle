...
namespace ScrewTurn.Wiki.Plugins.OracleCommon {
	...
	/// <summary>
	/// Implements a base class for a Oracle settings storage provider.
	/// </summary>
	public abstract class OracleSettingsStorageProviderBase : OracleStorageProviderBase, ISettingsStorageProviderV30 {
		...
		public IDictionary<string, string> GetAllSettings() {
			...
			if(reader != null) {
				...
				while(reader.Read()) {
					result.Add(reader["Name"] as string, (reader["Value"] as string).Trim());
				}
