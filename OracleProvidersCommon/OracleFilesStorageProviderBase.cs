...
namespace ScrewTurn.Wiki.Plugins.OracleCommon {
	...
	/// <summary>
	/// Implements a base class for a Oracle files storage provider.
	/// </summary>
	public abstract class OracleFilesStorageProviderBase : OracleStorageProviderBase, IFilesStorageProviderV30 {
