...
namespace ScrewTurn.Wiki.Plugins.OracleCommon {
	...
	/// <summary>
	/// Implements a base class for a Oracle users storage provider.
	/// </summary>
	public abstract class OracleUsersStorageProviderBase : OracleStorageProviderBase, IUsersStorageProviderV30 {
		...
		public UserInfo AddUser(string username, string displayName, string password, string email, bool active, DateTime dateTime) {
			...
			parameters.Add(new Parameter(ParameterType.Int32, "Active", active?1:0));
