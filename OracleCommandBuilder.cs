...
namespace ScrewTurn.Wiki.Plugins.Oracle {
	...
	/// <summary>
	/// Implements a command builder for Oracle.
	/// </summary>
	public class OracleCommandBuilder : ICommandBuilder {
        ...
        /// <summary>
        /// Gets the string to use in order to begin queries in a batch;
        /// </summary>
        public string BatchQueryStart {
            get { return "BEGIN "; }
        }

        /// <summary>
        /// Gets the string to use in order to end queries in a batch;
        /// </summary>
        public string BatchQueryEnd {
            get { return " END;"; }
        }
		...
		public DbConnection GetConnection(string connString) {
			DbConnection cn = new  OracleConnection(connString);
			cn.Open();
